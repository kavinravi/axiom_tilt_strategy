...
export const populated: Dataset = {
  ...
  holdings: [
    { ticker: "NVDA", company_name: "NVIDIA Corp", sector: "Technology", shares: 70, price: 132.4, market_value: 9268, weight_actual: 0.0889, weight_target: 0.10 },
    { ticker: "AAPL", company_name: "Apple Inc", sector: "Technology", shares: 40, price: 212.1, market_value: 8484, weight_actual: 0.0814, weight_target: 0.08 },
    { ticker: "MSFT", company_name: "Microsoft Corp", sector: "Technology", shares: 18, price: 441.0, market_value: 7938, weight_actual: 0.0762, weight_target: 0.075 },
    { ticker: "AVGO", company_name: "Broadcom Inc", sector: "Technology", shares: 45, price: 161.2, market_value: 7254, weight_actual: 0.0696, weight_target: 0.07 },
    { ticker: "GOOGL", company_name: "Alphabet Inc", sector: "Communication Services", shares: 38, price: 178.5, market_value: 6783, weight_actual: 0.0651, weight_target: 0.065 },
    { ticker: "ZZZQ", company_name: null, sector: null, shares: 10, price: 0, market_value: 0, weight_actual: 0, weight_target: 0.04 },
  ],
  weekly: [
